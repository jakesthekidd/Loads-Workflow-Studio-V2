...
@Component({
  selector: 'ws-selection-dropdown-settings',
...
export class SelectionDropdownSettingsComponent {
  /** Read-only: reflects whether the parent ActionType is single or multi. */
  readonly initialSelectionType = input<string>('Single-Select');
