...
@Component({
  selector: 'ws-accept-workflow-settings',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [FormsModule, InputTextModule, SelectModule],
  template: `
    <div class="field">
      <label class="field__label">Accept Work Flow Button Text</label>
      <input pInputText [(ngModel)]="buttonText" placeholder="Accept" class="w-full" />
    </div>
    <div class="field">
...
export class AcceptWorkflowSettingsComponent {
  readonly buttonText = model<string>('Accept');
